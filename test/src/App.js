...
import Quiz from './js/components/QuizPage/Quiz';
import Result from './js/components/ResultPage/Result';
import MaleFemale from "./js/components/MainPage/MaleFemale";
